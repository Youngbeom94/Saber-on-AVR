...
int16_t q1_barrett_reduce(int16_t a)
{
    int16_t t;
    // const int16_t v = ((1<<26) + NTT_Q1/2)/NTT_Q1;
...
int16_t q2_barrett_reduce(int16_t a)
{
    int16_t t;
    // const int16_t v = ((1<<26) + NTT_Q2/2)/NTT_Q2;
    const int16_t v = 6241;
