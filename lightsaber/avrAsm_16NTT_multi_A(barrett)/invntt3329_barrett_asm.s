 ...
 */
            EXTERN  q1_streamlined_CT_asm_inv_table
            EXTERN  q1_last_twist_table
            NAME    q1_barrett_invntt_asm   ;   module name
            PUBLIC  q1_barrett_invntt_asm   ;   make the main label vissible outside this module
...
mc_ct_brt_lo    MACRO    m_a0, m_a1, m_b0, m_b1, m_s1lo, m_s1hi, m_s2lo, m_s2hi, m_mont0, m_mont1, m_mont2, m_mont3, m_zero
    ...
    movw    m_s1lo, m_a0
    ldi     m_s2lo, 0xBF
    ldi     m_s2hi, 0x4E    ; m_s2 = v = 20159 = 0x4EBF
    ...
    movw    m_s1lo, m_mont2
    ldi     m_s2lo, 0x01
    ldi     m_s2hi, 0x0D    ; m_s2 = q = 3329 = 0x0D01
    mc_muls16x16_32 m_s1lo, m_s1hi, m_s2lo, m_s2hi, m_mont0, m_mont1, m_mont2, m_mont3, m_zero
    sub     m_a0,   m_mont0
    sbc     m_a1,   m_mont1
    st      X,      m_a1
...
initialize:
    ...
    ldi     r30,    low (q1_streamlined_CT_asm_inv_table)
    ldi     r31,    high(q1_streamlined_CT_asm_inv_table)
...
in4:
    ...
    mc_ct_hi        a0, a1, b0, b1   
    mc_barrett_mul  b0, b1, z0, z1, bp0, bp1, lo0, lo1, brt0, brt1, brt2, brt3, c_tmp, cst_q, zero        
    mc_ct_brt_lo    a0, a1, lo0, lo1, b0, b1, cst_q, c_tmp, brt0, brt1, brt2, brt3, zero    
